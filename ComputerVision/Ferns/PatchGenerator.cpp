...
PatchGenerator::PatchGenerator()
	: backgroundMin(0), backgroundMax(256)
	, noiseRange(5)
	, randomBlur(true)
	, lambdaMin(0.6), lambdaMax(1.5)
	, thetaMin(-CV_PI), thetaMax(CV_PI)
...
PatchGenerator::PatchGenerator(
	double _backgroundMin, double _backgroundMax,
...
void PatchGenerator::generateRandomTransform(
	Point2f srcCenter, Point2f dstCenter,
	Mat& transform, RNG& rng, bool inverse
) const
{
